...
router.put('/edit-user', multerMiddleware_1.uploadProfile, adminController_1.editUser);
router.delete('/delete-user/:id', adminController_1.deleteUser);
router.post('/add-user', multerMiddleware_1.uploadProfile, adminController_1.addUser);
